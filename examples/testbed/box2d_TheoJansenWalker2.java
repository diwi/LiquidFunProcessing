...
public class box2d_TheoJansenWalker2 extends PApplet {
  ...
  public void reset(){
    ...
    // Renderer
    bodyrenderer = new DwBodyRenderP5(this, world, world.transform);
    jointrenderer = new DwJointRenderP5(this, world, world.transform);
  ...
  public void draw(){
    ...
    world.transform.setCamera(car_pos.x/2, car_pos.y/2+10);
...
//    DwDebugDraw.displayJoints   (canvas, world);
  ...
  public static void main(String args[]) {
    PApplet.main(new String[] { box2d_TheoJansenWalker2.class.getName() });
  }
