...
public class box2d_TheoJansenWalker3 extends PApplet {
  ...
  public void initScene() {
...

    {
      ...
      bodies.add(m_wheel, true, color(255), true, color(0), 4f);
    }
  ...
  public static void main(String args[]) {
    PApplet.main(new String[] { box2d_TheoJansenWalker3.class.getName() });
  }
